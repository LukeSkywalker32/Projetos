...
const idade = 18;
const podeDirigir = idade >= 18 ? console.log("Pode dirigir") : console.log("Não pode dirigir");

// Exemplo com expressão mais complexa
const temperatura = 32;
const alerta = temperatura > 30 ? console.log("Temperatura muito alta") : console.log("Temperatura normal");
...
const numero = 7;
const resultado = numero > 10   // Se verdadeiro entao maior que 10
    ? "Maior que 10" 
